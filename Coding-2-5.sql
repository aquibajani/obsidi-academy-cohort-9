...
RETURNS TRIGGER AS
	$$ BEGIN -- Log the update action here (e.g., insert into a log table) RETURN NEW; END; $$ LANGUAGE PLPGSQL;
	CREATE TRIGGER PROFILE_UPDATE_TRIGGER BEFORE UPDATE ON PROFILE
